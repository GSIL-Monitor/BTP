...
namespace Alipay.Class
{
    ...
    public class Config
    {
        static Config()
        {
            ...
            #region 商户需要手动配置
            Partner = "2088501900862571";
            //交易安全检验码，由数字和字母组成的32位字符串
            Key = "12kv9arc6j9onrg4deosoo5mbtgxnaj9";
            Seller_account_name = "zhongxh@jh0101.com";
            Out_user = "";
            Call_back_url = ConfigurationManager.AppSettings["CallBackUrl"];
            Notify_url = ConfigurationManager.AppSettings["NotifyUrl"]; 
            Merchant_url = ConfigurationManager.AppSettings["MerchantUrl"];

            GatewayNotifyUrl = ConfigurationManager.AppSettings["GatewayNotifyUrl"];
            GatewayReturnUrl = ConfigurationManager.AppSettings["GatewayReturnUrl"];
            #endregion
        }
        ...
        /// Gateway方式服务器异步通知URL。
        /// </summary>
        public static string GatewayNotifyUrl { get; set; }

        /// <summary>
        /// Gateway方式返回URL。
        /// </summary>
        public static string GatewayReturnUrl { get; set; }
