...
(function ($) {
    ...
    $.fn.jqGrid = function (pin) {
		...
		setColWidth = function () {
		    var initwidth = 0, brd = $.jgrid.cell_width ? 0 : intNum(ts.p.cellLayout, 0), vc = 0, lvc, scw = ts.p.scrollOffset, cw, hs = false, aw, gw = 0,
			cl = 0, cr;
    ...
    */
    ...
    $.extend($.jgrid, {
        ...
        isEmpty: function (val) {
            if (typeof (val) != "undefined" && (val.match(/^\s+$/) || val === "")) {
                return true;
            } else {
                return false;
            }
                                                ...
                                                if ($.isFunction($t.p.afterSubmitCell)) {
                                                    ...
                                                    if (ret[0] === true) {
                                                        ...
                                                        if ($.isFunction($t.p.afterSaveCell)) {
                                                            $t.p.afterSaveCell.call($t, $t.rows[iRow].id, nm, v, iRow, iCol, result);
                                                        }
