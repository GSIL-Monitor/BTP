...
public class  imageUp: IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        context.Response.ContentType = "text/html";
            ...
            {
                HttpContext.Current.Response.Write("<script>document.domain = 'iuoooo.com';parent.UM.getEditor('"+ editorId +"').getWidgetCallback('image')('" + info["url"] + "','" + info["state"] + "')</script>");//回调函数
