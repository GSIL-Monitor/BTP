...
if (isIE == true) {
    var reg = /MSIE (\d)\.0/i;
    var regVal = reg.exec(navigator.userAgent);
    if (regVal && regVal[0] && regVal[0][1] && regVal[0][1] == 6) {
        isIE6 = true;
    }
}
var isIE10 = false;
...
ImgCropper.prototype = {
    ...
    initialize: function (container, handle, url, options) {
        ...
        this._Container.style.width = options.Width + "px";
        this._Container.style.height = options.Height + "px";

        this._layHandle.style.zIndex = 200;
        this._layHandle.style.width = options.minWidth + "px";
        this._layHandle.style.height = options.minHeight + "px";
        this._layHandle.style.left = 0;
        this._layHandle.style.top = 0;
        this._layHandle.style.cursor = "move";
        this._layHandle.style.border = "1px dashed #fff";
