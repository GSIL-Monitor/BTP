...
namespace Jinher.AMP.BTP.SV.Test
{
    ...
    public class MessageTest
    {
        ...
        [TestMethod]
        public void TestDeleteAllMessage()
        {
            string requestData = "{\"userId\":\"" + Setting.UserId + "\",\"appId\":\"" + Setting.AppId + "\"}";
            var rest = new RestRequestTest("Jinher.AMP.BTP.SV.MessageSV.svc/DeleteAllMessage");
            string retJson = rest.Execute(requestData);
            //ReturnDTO returnDTO = JsonHelper.JsonDeserialize<ReturnDTO>(retJson);
        }
    }
