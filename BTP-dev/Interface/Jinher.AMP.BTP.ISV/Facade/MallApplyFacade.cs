...
namespace Jinher.AMP.BTP.ISV.Facade
{
    public class MallApplyFacade : BaseFacade<IMallApply>
    {
        ...
        {
            base.Do();
            return this.Command.GetYJSellerInfoes(appIds);
        }
        /// <summary>
        /// 查询商城信息
        /// </summary>
        ...
        {
            base.Do();
            return this.Command.GetMallApplyInfoList(appId);
        }
        /// <summary>
        /// 获取商品列表 轮播图片 直播列表      
        /// </summary>
        ...
        {
            base.Do();
            return this.Command.GetCommodityListV3(search);
        }
        /// <summary>
        /// 获取App入驻类型
        /// </summary>
        ...
        {
            base.Do();
            return this.Command.GetMallTypeListByEsAppId(esAppId);
        }
    }
}