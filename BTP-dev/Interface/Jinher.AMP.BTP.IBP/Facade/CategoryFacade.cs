...
namespace Jinher.AMP.BTP.IBP.Facade
{
    public class CategoryFacade : BaseFacade<ICategory>
    {
        ...
        {
            base.Do();
            return this.Command.UpdateCategory2(appId, name, myId, icon, isuse);
        }
        /// <summary>
        /// 升级类别
        /// </summary>
        ...
        {
            base.Do();
            return this.Command.AddChildCategory2(name, targetId, appId, icon, isuse);
        }
        /// <summary>
        /// 创建初始类别
        /// </summary>
        ...
        public Jinher.AMP.BTP.Deploy.CustomDTO.ResultDTO InitAppCategory(Guid appId)
        {
            base.Do();
            return this.Command.InitAppCategory(appId);
        }
    }
}