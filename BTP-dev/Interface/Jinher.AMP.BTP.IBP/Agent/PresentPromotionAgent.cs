...
namespace Jinher.AMP.BTP.IBP.Agent
{
    ...
    public class PresentPromotionAgent : BaseBpAgent<IPresentPromotion>, IPresentPromotion
    {
        ...
        {
            //定义返回值
            Jinher.AMP.BTP.Deploy.CustomDTO.ResultDTO<Jinher.AMP.BTP.Deploy.CustomDTO.ListResult<Jinher.AMP.BTP.Deploy.CustomDTO.PresentPromotionSearchResultDTO>> result;

            try
            {
                //调用代理方法
                result = base.Channel.GetPromotions(input);
        ...
        public Jinher.AMP.BTP.Deploy.CustomDTO.ResultDTO EndPromotion(System.Guid id)
        {
            ...
            {
                //调用代理方法
                result = base.Channel.EndPromotion(id);
        ...
        public Jinher.AMP.BTP.Deploy.CustomDTO.ResultDTO DeletePromotion(System.Guid id)
        {
            ...
            {
                //调用代理方法
                result = base.Channel.DeletePromotion(id);
        ...
        {
            //定义返回值
            Jinher.AMP.BTP.Deploy.CustomDTO.ResultDTO<Jinher.AMP.BTP.Deploy.CustomDTO.PresentPromotionCreateDTO> result;

            try
            {
                //调用代理方法
                result = base.Channel.GetPromotionDetails(id);
        ...
        public Jinher.AMP.BTP.Deploy.CustomDTO.ResultDTO CreatePromotion(Jinher.AMP.BTP.Deploy.CustomDTO.PresentPromotionCreateDTO input)
        {
            ...
            {
                //调用代理方法
                result = base.Channel.CreatePromotion(input);
        ...
        public Jinher.AMP.BTP.Deploy.CustomDTO.ResultDTO UpdatePromotion(Jinher.AMP.BTP.Deploy.CustomDTO.PresentPromotionCreateDTO input)
        {
            ...
            {
                //调用代理方法
                result = base.Channel.UpdatePromotion(input);
        ...
        {
            //定义返回值
            Jinher.AMP.BTP.Deploy.CustomDTO.ResultDTO<Jinher.AMP.BTP.Deploy.CustomDTO.ListResult<Jinher.AMP.BTP.Deploy.CustomDTO.PresentPromotionCommoditySearchResultDTO>> result;
