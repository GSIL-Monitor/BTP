...
namespace Jinher.AMP.BTP.BP
{
    ...
    public partial class CommodityBP : BaseBP, ICommodity
    {
        ...
        {
            base.Do();
            return this.SaveCommodityExt(commodityAndCategoryDTO);
        }
        /// <summary>
        /// 修改商品
        /// </summary>
        ...
        {
            base.Do();
            return this.UpdateCommodityExt(commodityAndCategoryDTO);
        }
        /// <summary>
        /// 查询某个商家所有上架商品
        /// </summary>
        ...
        {
            base.Do();
            return this.GetAllCommodityBySellerIDBySalesvolumeExt(commoditySearch, out rowCount);
        }
        /// <summary>
        /// 查询某个商家所有下架商品
        /// </summary>
        ...
        {
            base.Do();
            return this.GetCommodityExt(id, appId);
        }
        /// <summary>
        /// 删除商品
        /// </summary>
        ...
        {
            base.Do();
            return this.DeleteGetCommodityExt(id);
        }
        /// <summary>
        /// 删除多个商品
        /// </summary>
        ...
        {
            base.Do();
            return this.DeleteCommoditysExt(ids);
        }
        /// <summary>
        /// 下架商品
        /// </summary>
        ...
        {
            base.Do();
            return this.UpdatePriceExt(id, price);
        }
        /// <summary>
        /// 修改库存
        /// </summary>
        ...
        {
            base.Do();
            return this.UpdateNameExt(id, name);
        }
        /// <summary>
        /// 获取商品类别
        /// </summary>
        ...
        {
            base.Do();
            return this.GetCategoryBycommodityIdExt(commodityId);
        }
        /// <summary>
        /// 编辑商品类别
        /// </summary>
        ...
        {
            base.Do();
            return this.UpdateCategoryBycommodityIdExt(uCategoryVM);
        }
        /// <summary>
        /// 根据分类获取商品列表
        /// </summary>
        ...
        {
            base.Do();
            return this.GetCommodityByCategoryIdExt(appId, categoryId);
        }
        /// <summary>
        /// </summary>
        /// <param name="id">商家ID</param>
        ...
        {
            base.Do();
            return this.IsExistsExt(code, appId);
        }
        public int GetCommodityNum(System.Guid appId, bool isDel, int state)
        {
            base.Do();
            return this.GetCommodityNumExt(appId, isDel, state);
        }
        ...
        {
            base.Do();
            return this.GetCommodityCodesExt(appid, commodityIds);
        }
        public string GetLastCommodityCode(System.Guid appId)
        {
            base.Do();
            return this.GetLastCommodityCodeExt(appId);
        }
        /// <summary>
        /// 保存商品排序结果
        /// </summary>
        ...
        {
            base.Do();
            return this.SaveCommoditySortValueExt(comIds);
        }
        /// <summary>
        /// 商品置顶排序
        /// </summary>
        ...
        {
            base.Do();
            return this.SetCommodityFirstExt(comId);
        }
        /// <summary>
        /// 关联商品列表
        /// </summary>
        ...
        {
            base.Do();
            return this.UpdateMarketPriceExt(id, marketPrice);
        }
        /// <summary>
        /// 修改进货价
        /// </summary>
        ...
        {
            base.Do();
            return this.UpdateCostPriceExt(id, costPrice);
        }
        /// <summary>
        /// 设置销售地区
        /// </summary>
        ...
        {
            base.Do();
            return this.UpdateCommodityListSaleAreasExt(ids, saleAreas);
        }
        /// <summary>
        /// 根据商品名称获取商品列表
        /// </summary>
        ...
        {
            base.Do();
            return this.SaveCommoditySharePercentExt(dto);
        }
        /// <summary>
        /// 获取店铺的分享分成信息。
        /// </summary>
        ...
        {
            base.Do();
            return this.GetCommoditySharePercentByAppIdExt(appId);
        }
        /// <summary>
        /// 设置商品是否参加分销
        /// </summary>
        ...
        {
            base.Do();
            return this.SetCommodityDistributionExt(commodityIdList, isDistribute);
        }
        /// <summary>
        /// 设置各分销商品佣金比例
        /// </summary>
        ...
        {
            base.Do();
            return this.SetDistributionAccountExt(commodityDistributionList);
        }
        /// <summary>
        /// 设置分销商品默认佣金比例
        /// </summary>
        ...
        {
            base.Do();
            return this.GetDefaulDistributionAccountExt(appId);
        }
        /// <summary>
        /// 上移一页保存商品
        /// </summary>
        ...
        {
            base.Do();
            return this.SaveUpCommoditySortValueExt(appId, comIds, id);
        }
        /// <summary>
        /// 下移一页保存商品
        /// </summary>
        ...
        {
            base.Do();
            return this.SaveDownCommoditySortValueExt(appId, comIds, id);
        }
        /// <summary>
        /// 保存商品积分抵用比例。
        /// </summary>
        ...
        {
            base.Do();
            return this.SaveCommodityScorePercentExt(dto);
        }
        /// <summary>
        /// 获取店铺的积分抵用信息。
        /// </summary>
        ...
        {
            base.Do();
            return this.GetCommodityScorePercentByAppIdExt(appId);
        }
        /// <summary>
        ...
        {
            base.Do();
            return this.GetCommodityBoxInfoExt(commodityId);
        }
        /// <summary>
        /// 获取推广主的分享分成信息。
        /// </summary>
        ...
        {
            base.Do();
            return this.GetCommoditySpreadPercentByAppIdExt(appId);
        }
        /// <summary>
        /// 保存推广主的分享分成比例。
        /// </summary>
        ...
        {
            base.Do();
            return this.GetSingleCommodityCodeExt(name, taxrate, pageIndex, pageSize);
        }
        ...
        {
            base.Do(false);
            return this.GetCommodityDetailExt(CommodityId);
        }
        ...
        {
            base.Do();
            return this.SetCommodityRefoundFreightTempExt(CommodityId, TempId);
        }
        /// <summary>
        /// 查询商品物流模板
        /// </summary>
        ...
        {
            base.Do();
            return this.GetCommodityFreightTemplateExt(AppId, GoodName, State, FreightID, pageIndex, pageSize);
        }
    }
}
