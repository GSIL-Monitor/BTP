...
namespace Jinher.AMP.BTP.BE
{
    public partial class ExpressCode
    {
        ...
        private volatile static List<ExpressCode> _allExpCodes = null;

        public static List<ExpressCode> AllExpCodes
        {
            get
            {
                if (_allExpCodes == null)
                {
                    _allExpCodes = ExpressCode.ObjectSet().ToList();
                }
                return _allExpCodes;
            }
        }
