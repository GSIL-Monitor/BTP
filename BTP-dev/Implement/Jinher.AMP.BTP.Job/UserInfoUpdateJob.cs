...
{
    public class UserInfoUpdateJob : IJob
    {

        public void Execute(JAP.Job.Engine.JobExecutionContext context)
        {
            ConsoleLog.WriteLog("定时更新评价表用户信息:UserInfoUpdateJob...begin");
            ...
            ConsoleLog.WriteLog("定时更新评价表用户信息:UserInfoUpdateJob...end");
        }
    }
}
